...
[界面截图](#界面截图) · [为什么做这个](#为什么做这个) · [快速开始](#快速开始) · [工作原理](#工作原理) · [支持的格式](#支持的转换) · [横向对比](#横向对比) · [隐私](#隐私) · [常见问题](#常见问题) · [参与贡献](#参与贡献) · [产品说明页](https://liaolongdong.github.io/transfer-any-file/)
...
<p align="center">
  ...
  <br />
  <sub><b>40 个文件进去，1 个 ZIP 出来</b> — 逐文件结果，一次打包下载。</sub>
</p>
...
**免费吗？**
免费。项目以 ISC 协议开源，没有账号、没有付费版、没有广告，也没有任何形式的升级引导——没有任何功能被锁在付费墙之后。
...
CHANGELOG.md           # 发布说明（.zh-CN.md 为中文对照）
CONTRIBUTING.md        # 一页说完全部贡献规则（.zh-CN.md 为中文对照）
SECURITY.md            # 漏洞披露渠道与离线攻击面说明（.zh-CN.md 为中文对照）
```
...
完整规则（新增转换器、编码约定、哪些文档必须同步改）见 [CONTRIBUTING.zh-CN.md](CONTRIBUTING.zh-CN.md) · [English](CONTRIBUTING.md)。安全问题请私密报告，不要开 issue：[SECURITY.zh-CN.md](SECURITY.zh-CN.md) · [English](SECURITY.md)。
